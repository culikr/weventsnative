...
class HomeScreen extends React.Component {
  ...
  //                   date: item.date,
  //                   max: jsonDataTemp.DailyForecasts[0].Temperature.Maximum.Value, //item.max,
  //                   min: jsonDataTemp.DailyForecasts[0].Temperature.Minimum.Value, //item.min,                   
  //                   image: jsonDataTemp.DailyForecasts[0].Day.Icon,
